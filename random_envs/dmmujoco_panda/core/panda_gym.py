...
class PandaGymEnvironment(RandomEnv):
    ...
    def _initialize_simulation(self):
        ...
        # self.model = mujoco.MjModel.from_xml_path('random_envs/dmmujoco_panda/franka_sim/parsed_xml.xml')
    ...
    # def _reset_to_home_keyframe():
    #     """Test method which uses the predefined model keyframe
    #     to reset the simulation environment"""
    ...
    def _set_limits(self):
        ...
        # qacc limits
        self.joint_qacc_max = np.array([15, 7.5, 10, 12.5, 15, 20, 20])*0.8
