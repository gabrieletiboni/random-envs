...
import random_envs
from random_envs.dmmujoco_panda.core.panda_gym import PandaGymEnvironment
...
from random_envs.dmmujoco_panda.core.utils import register_panda_env, distance_penalty
...
register_panda_env(
        id="DMPandaReach-FFPosCtrl-GoalA-v0",
        entry_point="%s:PandaReachEnv" % __name__,
        model_file="TableScene.xml",
